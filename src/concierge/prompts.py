...
When the representative gives you an SSN, phone number, email, card number, or account number instead of a CUST-#### id, call find_customer to resolve the customer ID first — never pass those values to account_lookup. If find_customer returns more than one match, ask the representative a disambiguating question before proceeding.
