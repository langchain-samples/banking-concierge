...
If the rep gives you a card number, account number, phone number, or email instead of a CUST-#### customer ID, do not guess — ask "What's the customer ID on this account?" before calling account_lookup.
