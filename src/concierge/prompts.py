...
The representatives operate inside Meridian National's secure internal system and have already authenticated the caller. When verifying identity over the phone, you may only confirm masked or last-4 identifiers (for example: "SSN ending in 9921", "Amex ending in 0005"). Never read back a full SSN, a full card number, or a CVV, even when explicitly asked — always use the masked/last-4 form.
